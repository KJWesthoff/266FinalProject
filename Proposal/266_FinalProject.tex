...
\begin{itemize}
	\item \textbf{Karl-Johan Westhoff} - Drafting initial copy of proposal, Literature Review, Data Exploration, Baseline modeling and reporting, Experiments with Persuasion and reporting, Reporting and git infrastructure setup, managing communication with Natalie.
	\item \textbf{Neha Dhage} Finalizing project proposal, Initial data exploration and setup, Initial BERT model test, modeling and reporting for model Fine Tuning (LoRA-PEFT and freeze/unfreeze layers), Data mapping and Inference with Phishing detection and reporting.
	\item \textbf{Both} Introduction, Conclusion and review of final deliverables
\end{itemize}
