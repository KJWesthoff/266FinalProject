...
\begin{itemize}
	\item \textbf{Karl-Johan Westhoff} - Literature Review, Data Exploration, Baseline modeling and reporting, Experiments with Persuasion, Reporting infrastructure setup.
	\item \textbf{Neha Dhage} Initial data setup, modeling and reporting for model Fine Tuning, Experiments with Phishing
	\item \textbf{Both} Introduction, Conclusion
\end{itemize}
