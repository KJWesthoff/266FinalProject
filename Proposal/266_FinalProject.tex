...
We showed that RoBERTa, when fine-tuned, provided the most stable and accurate results among transformer-based models. Our LoRA/PEFT experiments confirmed that parameter-efficient fine-tuning could be used effectively for manipulation detection. By selectively unfreezing higher transformer layers (e.g., layers 10 and 11), we were able to recover strong performance while maintaining efficiency.
...
\begin{appendices}
	...
	See Figure \ref{fig:PersuasionLabelDistribution}
    \begin{figure}[!htp] % Single column :figure	
		\centering
