...
\subsection{Labels}
The dataset uses a complex labeling system based on the taxonomy in Figure \ref{fig:Taxonomy}, with uneven label distribution—‘Manipulative’ appears 2.4× more than ‘Non-manipulative’. Some 'Technique' and 'Vulnerability' fields have multiple or missing values.  See details in Appendix \ref{appendix:Labels}. For phishing detection the most frequent label, ‘Persuasion and Seduction’, seemed most interesting though this creates class imbalance (4.2× more negatives than positives).
...
\subsection{Persuasion - Feature Engineering}
